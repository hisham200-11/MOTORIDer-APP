...
ALTER TABLE `ride_requests`
  ...
  ALTER TABLE ride_requests MODIFY COLUMN dropoff VARCHAR(225) DEFAULT 'Unknown Location';
  SELECT pickup, dropoff FROM ride_requests WHERE status='pending' LIMIT 1;
COMMIT;
